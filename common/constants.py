...
SPARK_APP_NAME = "IDS for LoRaWAN network"
SPARK_EXECUTOR_MEMORY = "40g"                  # Memory available for the Spark executor; you might have to adjust this value according to the amount of memory of your machine
SPARK_DRIVER_MEMORY = "40g"                    # Memory available for the Spark driver; you might have to adjust this value according to the amount of memory of your machine
...
POWE_ABNORMAL_VALUES = [random.randint(200, 10000) for _ in range(7)]
...
FPORT_VALUES = [random.randint(1, 223) for _ in range(10)]
FREQ_VALUES = [round(random.uniform(867, 869), 1) for _ in range(7)]
SIZE_ABNORMAL_VALUES = [random.randint(200, 10000) for _ in range(7)]
FOPTS_VALUES = [random.randint(0, pow(2, 15 * 8)) for _ in range(10)]